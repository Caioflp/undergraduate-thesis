...
\ifnum\value{num}=1
{
    ...
    \input{structure/ficha-catalografica}

    \input{structure/folha-aprovacao}

    \input{structure/dedicatoria-agradecimentos}

    \hbadness=0
    \hfuzz=0pt

    \input{structure/resumo}
    ...
    \input{structure/siglas-simbolos.tex}
...
\input{chapters/instrumental-variable}
\input{chapters/npiv-and-lip}
\input{chapters/npiv-and-sgd}

...
\headerbox{1. Abstract}{name=abstract,column=0,row=0, span=1}{
    ...
    \begin{itemize}
        \item IV regression is formulated as an statistical inverse problem;
...
\headerbox{2. NPIV regression}{name=npiv,column=0,below=abstract,span=1}{
...
\headerbox{5. Numerical Experiment}{name=experiment,column=0,span=2,below=theorem}{
...
\headerbox{6. Next Steps}{name=next-steps,column=0,below=experiment,span=1,above=bottom}
{
    \vspace{1em}
    \begin{itemize}
        \item More thorough benchmarks;
        \item Application to discrete outcomes $ Y = \ind \left\{ \hstar ( X ) > 0 \right\} $;
    \end{itemize}
}

\headerbox{7. References}{name=references,column=1,below=experiment,span=1,above=bottom}{
    \tiny
